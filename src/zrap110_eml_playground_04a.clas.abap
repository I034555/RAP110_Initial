class ZRAP110_EML_PLAYGROUND_04A definition
  public
  final
  create public .
...
CLASS ZRAP110_EML_PLAYGROUND_04A IMPLEMENTATION.


METHOD IF_OO_ADT_CLASSRUN~MAIN.
     "declare internal table using derived type
     DATA travel_keys TYPE TABLE FOR READ IMPORT ZRAP110_R_TravelTP_04A .
     ...
     READ ENTITIES OF ZRAP110_R_TravelTP_04A
       ENTITY Travel
*        ALL FIELDS
