...
define view entity ZRAP110_R_BOOKINGTP_04A
  as select from ZRAP110_ABOOK04A as Booking
  association to parent ZRAP110_R_TRAVELTP_04A as _Travel on $projection.TravelID = _Travel.TravelID
